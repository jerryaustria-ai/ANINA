...
export default function ClientMembership() {
  ...
  async function load() {
    const [plan, history] = await Promise.all([
      api("/memberships/mine"), api("/guest-checkout/history/mine"),
    ]);
  ...
  return <div className="page">
    <div className="page-head"><div><h1>My Memberships</h1>
      <p>View your active class plan and purchase history.</p></div>
    ...
    <h2 style={{ margin: "1.5rem 0 .8rem", fontWeight: 300 }}>Purchase History</h2>
